...
<div class="main">
  <div class="container p-4">
      <table class="table tabl-bordered">
          ...
          $sql = "SELECT * FROM report WHERE Email = '".$_SESSION['Email']."' AND DeletionStatus = 0 AND ReportDate = '".$_POST['Date']."'";
          ...
          foreach($result as $row){
              ...
              <tr>
                  ...
                  <td>  <a href="<?php echo $row["ReportFile"]  ?>" target="_blank">Download</a></td>
                 </tr>
              <?php
          }
          ?>
